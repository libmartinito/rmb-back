...
exports.router.patch("/api/tickets/admin/:ticketcrf", auth_1.auth, ticketsController.updateOne);
// Route for a user updating a ticket
exports.router.patch("/api/tickets/user/:ticketcrf", auth_1.auth, ticketsController.updateCopy);
